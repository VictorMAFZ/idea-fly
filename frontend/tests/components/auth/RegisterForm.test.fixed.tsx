...
describe('RegisterForm Component', () => {
  ...
  describe('Rendering', () => {
    ...
    test('applies custom className when provided', () => {
      ...
      const formContainer = screen.getByRole('heading', { name: /crear cuenta/i }).closest('div');
  ...
  describe('Form Validation', () => {
    ...
    describe('Confirm Password validation', () => {
      test('shows error for empty confirmation', async () => {
        ...
        await waitFor(() => {
          expect(screen.getByText(/la confirmación de contraseña es requerida/i)).toBeInTheDocument();
        });
      });
      ...
      test('accepts matching passwords', async () => {
        ...
        await waitFor(() => {
          expect(screen.queryByText(/la confirmación de contraseña es requerida/i)).not.toBeInTheDocument();
  ...
  describe('Accessibility', () => {
    ...
    test('supports keyboard navigation', async () => {
      ...
      await user.tab();
      expect(document.activeElement).toBe(screen.getByLabelText(/nombre completo/i));
      
      await user.tab();
      expect(document.activeElement).toBe(screen.getByLabelText(/email/i));
      
      await user.tab();
      expect(document.activeElement).toBe(screen.getByLabelText(/^contraseña$/i));
      
      await user.tab();
      expect(document.activeElement).toBe(screen.getByLabelText(/confirmar contraseña/i));
      
      await user.tab();
      expect(document.activeElement).toBe(screen.getByRole('button', { name: /crear cuenta/i }));
    });
  });
